...
public class AutoPlay implements IVoicedCommandHandler
{
	...
	private static final Consumer<OnPlayerLogin> ON_PLAYER_LOGIN = event ->
	{
		...
		{
			player.sendPacket(new CreatureSay(null, ChatType.ANNOUNCEMENT, "自動練功", Config.AUTO_PLAY_LOGIN_MESSAGE));
		}
	...
	public boolean useVoicedCommand(String command, Player player, String params)
	{
		...
		{
			player.sendPacket(new ExShowScreenMessage("此命令僅適用於高級會員。", 5000));
			player.sendMessage("此命令僅適用於高級會員。");
		...
		switch (command)
		{
			...
			case "play":
			{
				...
				content = content.replace("%skill_button%", Config.ENABLE_AUTO_SKILL ? "<br><table width=295><tr><td height=31><center><button action=\"bypass voice .playskills\" value=\"選擇技能\" width=240 height=31 back=\"L2UI_CT1.HtmlWnd_DF_Level_Down\" fore=\"L2UI_CT1.HtmlWnd_DF_Level\"></center></td></tr></table>" : "");
				content = content.replace("%item_button%", Config.ENABLE_AUTO_ITEM ? "<br><table width=295><tr><td height=31><center><button action=\"bypass voice .playitems\" value=\"選擇輔助道具\" width=240 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_BuyEquip_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_BuyEquip\"></center></td></tr></table>" : "");
				content = content.replace("%potion_button%", Config.ENABLE_AUTO_POTION ? "<br><table width=295><tr><td height=31><center><button action=\"bypass voice .playpotion\" value=\"選擇治療藥水\" width=240 height=31 back=\"L2UI_CT1.OlympiadWnd_DF_Reward_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Reward\"></center></td></tr><tr><td height=31><center><table width=150><tr><td width=120><font color=\"CDB67F\">HP百分比 (%percent%)</font></td><td><edit var=\"percentbox\" width=30 height=15></td><td><button value=\"確定\" action=\"bypass voice .play percent $percentbox\" width=45 height=21 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table></center></td></tr></table>" : "");
				content = content.replace("%percent%", String.valueOf(player.getAutoPlaySettings().getAutoPotionPercent()));

				if (player.isAutoPlaying())
				{
					content = content.replace("%status_button%", "<table width=295><tr><td height=31><center><table width=295><tr><td height=31><center><button action=\"bypass voice .play stop\" value=\"停止\" width=240 height=31 back=\"L2UI_CT1.HtmlWnd_DF_Campaign_Down\" fore=\"L2UI_CT1.HtmlWnd_DF_Campaign\"></td></tr></table></center></td></tr></table>");
				}
				else
				{
					content = content.replace("%status_button%", "<table width=295><tr><td height=31><center><table width=295><tr><td height=31><center><button action=\"bypass voice .play start\" value=\"開始\" width=240 height=31 back=\"L2UI_CT1.HtmlWnd_DF_Campaign_Down\" fore=\"L2UI_CT1.HtmlWnd_DF_Campaign\"></td></tr></table></center></td></tr></table>");
				}
			...
			case "playskills":
			{
				...
				if (skills.isEmpty())
				{
					sb.append("<center><br>找不到技能。<br></center>");
				}
				else
				{
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass voice .playskills " + (page - 1) + "\"><font color=\"CDB67F\">上一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一頁</font></td>");
					}
					sb.append("<td align=center width=100>第 " + page + " 頁，共 " + max + " 頁</td>");
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass voice .playskills " + (page + 1) + "\"><font color=\"CDB67F\">下一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一頁</font></td>");
					}
					sb.append("</tr></table><img src=\"L2UI.SquareGray\" width=295 height=1>");
				}
			...
			case "playpotion":
			{
				...
				if (items.isEmpty())
				{
					sb.append("<center><br>找不到藥水。<br></center>");
				}
				else
				{
					// Generate item table.
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass voice .playpotion " + (page - 1) + "\"><font color=\"CDB67F\">上一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一頁</font></td>");
					...
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass voice .playpotion " + (page + 1) + "\"><font color=\"CDB67F\">下一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一頁</font></td>");
			...
			case "playitems":
			{
				...
				if (items.isEmpty())
				{
					sb.append("<center><br>找不到道具。<br></center>");
				}
				else
				{
					// Generate item table.
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass voice .playitems " + (page - 1) + "\"><font color=\"CDB67F\">上一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一頁</font></td>");
					...
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass voice .playitems " + (page + 1) + "\"><font color=\"CDB67F\">下一頁</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一頁</font></td>");
