...
public class frmAbout
{
	...
	private void initialize()
	{
		...
		final JLabel lblLoginServer = new JLabel("登錄服務器");
		lblLoginServer.setForeground(TEXT_COLOR);
		lblLoginServer.setHorizontalAlignment(SwingConstants.CENTER);
		lblLoginServer.setFont(new Font("微軟雅黑", Font.PLAIN, 14));
		lblLoginServer.setBounds(10, 86, 330, 23);
		contentPanel.add(lblLoginServer);
		...
		lblAuthor.setBounds(10, 120, 330, 23);
		...
		lblContact.setBounds(10, 145, 330, 23);
		...
		lblCopyright.setBounds(10, 215, 330, 14);
